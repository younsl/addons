...
Go 1.27.0 filesystem cleaner for Kubernetes, run as an init container (`once` mode) or sidecar (`interval` mode). Ported from Rust. Standard library only — do not add third-party dependencies without a strong reason.
