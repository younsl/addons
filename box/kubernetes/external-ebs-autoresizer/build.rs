...
fn main() {
    ...
    // The toolchain that built the binary (e.g. "1.98.0" from
    // "rustc 1.98.0 (abc123 2026-08-18)"), so the startup log names the
    // runtime the way the Go version named its Go release.
