...
Backstage version is pinned in `backstage.json` (currently 1.54.7). Yarn is managed by Corepack, so do not install it globally; running any `yarn` command in this directory picks up the pinned 4.12.0.
