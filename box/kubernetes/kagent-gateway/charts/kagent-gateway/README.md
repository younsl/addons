...
```console
helm install kagent-gateway oci://ghcr.io/younsl/charts/kagent-gateway --version 0.2.1
```
...
```console
helm pull oci://ghcr.io/younsl/charts/kagent-gateway --untar --version 0.2.1
